...
namespace VisualPinball.Engine.Unity.BulletPhysics
{
	...
	public class PhyBody 
    {
		...
		static readonly Dictionary<int, CollisionObject> _collisonObjects = new Dictionary<int, CollisionObject>();
		public static RigidBody GetCollisionObject(int idx) { return (RigidBody)_collisonObjects?[idx]; }

		private void _AddToList()
		{
			RigidBodyIdx = PhyBodyCounter;
			_collisonObjects[RigidBodyIdx] = collisionObject;
			++PhyBodyCounter;
		}
